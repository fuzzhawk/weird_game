...
const SCHEMA=[
  ...
  {k:'bodyW',g:'Body',l:'Width',t:'r',min:2,max:5.25,st:.25,d:3.5},
  {k:'bodyH',g:'Body',l:'Height',t:'r',min:4,max:9.5,st:.5,d:6},
  ...
  {k:'legLen',g:'Legs',l:'Length',t:'r',min:5,max:7,st:.5,d:6},
...
const PRESETS={
  ...
  // ---- humanoid folk (smaller, people-shaped) ----
  Elf:{earType:'pointed',earSize:3.5,hornType:'none',tailType:'none',hairType:'ponytail',hairHue:40,snout:0,
    cloth:'tunic',belt:true,chest:'none',helmet:'none',boots:true,shoes:true,spikes:'none',tex:'smooth',
    attackStyle:'stab',bodyW:3,bodyH:6.5,taper:-.2,legLen:7,armLen:5,headSize:.5,hue:28,sat:26,lit:70,clothHue:150},
  Dwarf:{earType:'round',earSize:2,hornType:'none',tailType:'none',hairType:'wild',hairHue:20,snout:0,
    cloth:'tunic',belt:true,chest:'half',helmet:'none',boots:true,shoes:true,spikes:'none',tex:'smooth',
    attackStyle:'slash',bodyW:4.5,bodyH:4.5,taper:-.2,legLen:5,legThick:2,armLen:4.5,armThick:1.6,headSize:.6,
    hue:22,sat:34,lit:60,clothHue:20,metalHue:30},
  Halfling:{earType:'round',earSize:2.5,hornType:'none',tailType:'none',hairType:'curly',hairHue:30,snout:0,
    cloth:'shirt',belt:true,chest:'none',helmet:'none',boots:false,shoes:false,spikes:'none',tex:'smooth',
    attackStyle:'stab',bodyW:3.25,bodyH:4,taper:-.2,legLen:5,armLen:4,headSize:.8,headRound:.9,hue:30,sat:36,lit:66},
  Ranger:{earType:'round',earSize:2,hornType:'none',tailType:'none',hairType:'swept',hairHue:18,snout:0,
    cloth:'tunic',belt:true,chest:'none',helmet:'none',boots:true,shoes:true,spikes:'none',tex:'smooth',
    attackStyle:'stab',bodyW:3.5,bodyH:6,legLen:6.5,armLen:5,headSize:.5,hue:110,sat:30,lit:48,clothHue:110},
  Bard:{earType:'pointed',earSize:2.5,hornType:'none',tailType:'none',hairType:'topknot',hairHue:280,snout:0,
    cloth:'robe',belt:true,chest:'none',helmet:'none',boots:false,shoes:true,spikes:'none',tex:'smooth',
    attackStyle:'cast',bodyW:3.25,bodyH:6,legLen:6,armLen:4.5,headSize:.5,hue:300,sat:40,lit:64,clothHue:290},
  Monk:{earType:'round',earSize:2,hornType:'none',tailType:'none',hairType:'none',snout:0,
    cloth:'robe',belt:true,chest:'none',helmet:'none',boots:false,shoes:false,spikes:'none',tex:'smooth',
    attackStyle:'claw',bodyW:3.5,bodyH:6,legLen:6,armLen:5,headSize:.55,headRound:.92,hue:32,sat:24,lit:58,clothHue:32},
  Barbarian:{earType:'round',earSize:2,hornType:'none',tailType:'none',hairType:'mohawk',hairHue:15,snout:0,
    cloth:'none',belt:true,chest:'none',helmet:'none',pauldrons:true,boots:true,shoes:false,spikes:'none',tex:'fur',texAmt:.5,
    attackStyle:'slash',bodyW:4.5,bodyH:6.5,taper:-.3,legLen:6,legThick:2,armLen:5,armThick:1.6,headSize:.45,hue:20,sat:30,lit:56},
  Noble:{earType:'round',earSize:2,hornType:'none',tailType:'none',hairType:'bun',hairHue:45,snout:0,
    cloth:'robe',belt:true,chest:'none',helmet:'none',boots:false,shoes:true,gauntlets:false,spikes:'none',tex:'smooth',
    attackStyle:'cast',bodyW:3.25,bodyH:6.5,legLen:6.5,armLen:4.5,headSize:.5,hue:270,sat:38,lit:62,clothHue:275,metalHue:45},
  Child:{earType:'round',earSize:2.5,hornType:'none',tailType:'none',hairType:'bowl',hairHue:28,snout:0,
    cloth:'shirt',belt:false,chest:'none',helmet:'none',boots:false,shoes:true,spikes:'none',tex:'smooth',
    attackStyle:'stab',bodyW:3,bodyH:4,taper:-.15,legLen:5,armLen:4,headSize:.9,headRound:.92,footSize:1.9,hue:30,sat:40,lit:68},
  Wanderer:{earType:'pointed',earSize:2.5,hornType:'none',tailType:'none',hairType:'fringe',hairHue:12,snout:0,
    cloth:'robe',belt:true,chest:'none',helmet:'none',boots:true,shoes:true,spikes:'none',tex:'smooth',
    attackStyle:'stab',bodyW:3.5,bodyH:6,legLen:6,armLen:4.5,headSize:.5,hue:35,sat:22,lit:52,clothHue:35},
};
